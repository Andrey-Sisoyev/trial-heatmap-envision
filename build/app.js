...
(function() {
  var assert, assets, books_stats, dbDefineExpress, dbInit, dbServices, express, http, orm, prettyjson, rack, utils, version;
  ...
  assets.on('complete', function() {
    ...
    app.use(assets);
    app.use(orm.express("postgresql://master:qwerty123@127.0.0.1/master", {
      define: dbDefineExpress
    }));
    app.use(app.router);
